...
function App() {
  ...
  const OrganizerDashboard = () => {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50">
        ...
        {/* Modal de vote des scrutateurs supprimé - génération directe maintenant */}
      </div>
    );
  };
  ...
  return (
    <div className="App">
      ...
      {showInfoModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-y-auto scrollbar-thin scrollbar-thumb-blue-300 scrollbar-track-gray-100">
            {/* Header du modal */}
            <div className="bg-gradient-to-r from-blue-600 to-blue-700 text-white p-6">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
            ...
            <div className="p-8 space-y-6">
              ...
              {/* Footer du modal */}
              <div className="border-t border-slate-200 p-6 bg-gray-50">
                <div className="text-center">
